...
if ( ! function_exists( 'custom_button' ) ) :
	function custom_button( $links = array( 'custom_link', 'dropdown_link', 'button_text' ) ) {
		...
		if ( $custom_link ) :
			printf( '<a href="' . $custom_link . '" class="text-uppercase what-we-do-button">' . $button_text . '</a>' );
		else :
			printf( '<a href="' . $dropdown_link . '" class="text-uppercase what-we-do-button">' . $button_text . '</a>' );
		endif;
	}
endif;